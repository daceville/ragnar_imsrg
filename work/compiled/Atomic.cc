...
int main(int argc, char** argv)
{
  ...
  bool setNuclear = false;
  cout << "About to construct modelspace"<<endl;
  ModelSpace modelspace = ModelSpace(eMax,reference,valence_space,setNuclear);
  //ModelSpace modelspace = reference=="default" ? ModelSpace(eMax,valence_space,setNuclear) : ModelSpace(eMax,reference,valence_space,setNuclear);
  //modelspace.SetNuclear(false);
